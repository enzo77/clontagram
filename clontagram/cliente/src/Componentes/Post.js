...
export default function Post({ post, actualizarPost, mostrarError, usuario  }) {
    const { numLikes, numComentarios, _id, caption, url, usuario:usuarioDelPost, estaLike } =  post;
    ...
    return (
        <div className="Post-Componente">
            ...
            <div className="Post-Componente__acciones">
                <div className="Post-Componente__like-contanier">
...
function VerTodosLosComentarios({ _id, numComentarios }) {
    ...
    return (
        <li className="text-grey-dark">
            <Link to={`/post/${_id}`}>
                Ver todos los {numComentarios} comentarios
            </Link>
        </li>
    );
}
